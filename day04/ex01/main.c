...
int main(void)
{
	...
	while (1)
	{
		...
		// Configuration initiale pour recevoir des données avec ACK ou NACK
		// i2c_request_data(1); // Pour ACK
		// for (int i = 0; i < 7; i++)
		// {				// Lire 7 octets de données
		// 	i2c_read(); // Lire et afficher chaque octet
		// 	uart_print(" ");
		// }
		for (int i = 0; i < 7; i++)
		{
